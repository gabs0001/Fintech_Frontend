    ...
    >
      <form onSubmit={(e) => e.preventDefault()}>
        <div className="flex justify-end">
          <h2 id="popUpTitle" className="sr-only">Editar</h2>
          <button
            type="button"
            onClick={onFechar}
        ...
        <div className="space-y-4 mt-4">
            ...
            <div key={campo.nome}>
              ...
              {campo.tipo === 'textarea' ? (
                <textarea
                  ...
                  className="w-full rounded-md bg-[#343F57] text-white p-2"
                />
              ) : (
                <input
                  id={`editar-${campo.nome}`}
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button
              type="button"
              onClick={onFechar}
              className="bg-[#0aa6ab] hover:bg-[#075e61] text-white px-6 py-2 rounded-md"
            >
              Cancelar
            </button>
            <button
